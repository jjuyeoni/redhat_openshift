@font-face {
    font-family: HimChan;
    src: url("DXHmchB-KSCpc-EUC-H.ttf");
}
...
#mainNav .navbar-brand {
  ...
  color: #F05F40;
  font-family: 'Himchan', 'Open Sans', 'Helvetica Neue', Arial, sans-serif;
}
...
.btn_more button:before,.btn_more button:after{
  content:'';
  position:absolute;
  top:0;
  right:0;
...
.btn_more button:hover:before,.btn_more button:hover:after{
  width:100%;
  transition:800ms ease all;
}
.img-fluid {
...
.btn_more_right:hover span {
  padding-right: 25px;
  color:#F05F40;
}
.btn_more_right:hover {
  color:#F05F40;
}
.btn_more_right:hover span:after {
  opacity: 1;
  right: 0;
  color:#F05F40;
}
